        ...
        token: function(stream, state) {
            ...
            //  if (sol)
            {
                ...
                if (stream.match(reg_sectionNames, true)) {
                    ...
                    // console.log("section=%s, lineNumber=%s", state.section, state.lineNumber);

                    // Record the start and ends of each section.
                    if (!state.sectionLineNumbers) {
                        state.sectionLineNumbers = {};
                    }

                    if (!(state.section in state.sectionLineNumbers)) {
                        state.sectionLineNumbers[state.section] = [state.lineNumber, state.lineNumber];
                    }
